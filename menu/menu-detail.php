...
<head>
    ...
    <link rel="stylesheet" href="../css/menu-detail.css?v=<?php echo time(); ?>">
    <title>Cafe Kinton | <?= $dataProduct['nama_product']; ?></title>
</head>
<body>
...
<div class="container-detail">
    ...
    <div class="detail-right">
        <h1><?= $dataProduct['nama_product']; ?></h1>
    <div class="price">
        <h3>Rp <?= number_format($dataProduct['harga']); ?></h3>
    </div>
    <div class="terjual">
        <p>Terjual <span class="terjual-counter"><?= $dataProduct['terjual']; ?></span></p>
    </div>
    <div class="tgl_tambah">
        <p>Tanggal Tambah <span class="tanggal"><?= $dataProduct['tgl_tambah']; ?></span></p>
    </div>
    <div class="deskripsi">
        <textarea disabled>
    ...
    <div class="order-button">
        <a href="../shop/shop-detail.php?id=<?= $dataProduct['id']; ?>">
            <span class="btn order"><i class="fas fa-store"></i>&nbsp;&nbsp;Shop</span>
        </a>
    </div>
    </div>
</div>
...
<div class="container-detail2">
    ...
    <div class="tgl_tambah2">
        <p>Tanggal Tambah <span class="tanggal2"><?= $dataProduct['tgl_tambah']; ?></span></p>
    </div>
    ...
    <div class="order-button2">
        <a href="../shop/shop-detail.php?id=<?= $dataProduct['id']; ?>">
            <span class="btn order2"><i class="fas fa-store"></i>&nbsp;&nbsp;Shop</span>
        </a>
    </div>
    </div>
</div>
...
<div class="rekomen-wrapper">
      <div class="container-rekomen">
        <div class="rekomen">
        <a href="menu-detail.php?id=<?= $dataRekomendasiProduct[0]['id']; ?>">
            <div class="logo">
              <img class="resize-image" src="../uploads/<?= $dataRekomendasiProduct[0]['gambar']; ?>"/>
            </div>
            <div class="title">
              <h3><?= $dataRekomendasiProduct[0]['nama_product']; ?></h3>
            </div>
          </a>
        </div>
        <div class="rekomen">
        <a href="menu-detail.php?id=<?= $dataRekomendasiProduct[1]['id']; ?>">
            <div class="logo">
              <img class="resize-image" src="../uploads/<?= $dataRekomendasiProduct[1]['gambar']; ?>"/>
            </div>
            <div class="title">
              <h3><?= $dataRekomendasiProduct[1]['nama_product']; ?></h3>
            </div>
          </a>
        </div>
        <div class="rekomen">
        <a href="menu-detail.php?id=<?= $dataRekomendasiProduct[2]['id']; ?>">
            <div class="logo">
              <img class="resize-image" src="../uploads/<?= $dataRekomendasiProduct[2]['gambar']; ?>"/>
            </div>
            <div class="title">
              <h3><?= $dataRekomendasiProduct[2]['nama_product']; ?></h3>
            </div>
          </a>
        </div>
        <div class="rekomen">
        <a href="menu-detail.php?id=<?= $dataRekomendasiProduct[3]['id']; ?>">
            <div class="logo">
              <img class="resize-image" src="../uploads/<?= $dataRekomendasiProduct[3]['gambar']; ?>"/>
            </div>
            <div class="title">
              <h3><?= $dataRekomendasiProduct[3]['nama_product']; ?></h3>
            </div>
          </a>
        </div>
      </div>
