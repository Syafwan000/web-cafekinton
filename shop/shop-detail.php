...
<div class="rekomen-wrapper">
      ...
      <div class="rekomen">
            ...
            <div class="content">
              <p>Terjual <span class="terjual-counter"><?= $dataRekomendasiProduct[0]['terjual']; ?></span></p>
              <p>Rp <?= number_format($dataRekomendasiProduct[0]['harga']); ?></p>
            </div>
        ...
        <div class="rekomen">
            ...
            <div class="content">
              <p>Terjual <span class="terjual-counter"><?= $dataRekomendasiProduct[1]['terjual']; ?></span></p>
              <p>Rp <?= number_format($dataRekomendasiProduct[1]['harga']); ?></p>
            </div>
        ...
        <div class="rekomen">
            ...
            <div class="content">
              <p>Terjual <span class="terjual-counter"><?= $dataRekomendasiProduct[2]['terjual']; ?></span></p>
              <p>Rp <?= number_format($dataRekomendasiProduct[2]['harga']); ?></p>
            </div>
        ...
        <div class="rekomen">
            ...
            <div class="content">
              <p>Terjual <span class="terjual-counter"><?= $dataRekomendasiProduct[3]['terjual']; ?></span></p>
              <p>Rp <?= number_format($dataRekomendasiProduct[3]['harga']); ?></p>
            </div>
