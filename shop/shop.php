      ...
      <div class="container">
        ...
        <div class="shop">
            ...
            <div class="content">
              ...
              <p>Rp <?= number_format($dataProduct['harga']); ?></p>
            </div>
            <a href="shop-detail.php?id=<?= $dataProduct['id']; ?>">
            <div class="btn-shop">
                <span class="btn shop-btn">Order Now</span>
            </div>
          </a>
        </div>
        <?php endforeach; ?>
